...
export default function Home() {
  return (
    <>
      ...
      <footer className="footer"><div className="container footer-inner"><Brand /><span>© 2026 LanturAI. MVP chatbot multi-tenant.</span><span>Next.js · Supabase · Gemini</span></div></footer>
    </>
  );
}
